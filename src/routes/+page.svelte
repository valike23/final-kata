<script lang="ts">
	...
	import type { Idashboard } from '$lib/types/dashboard.types';
	import { onMount } from 'svelte';
    let dataBoard: Idashboard = {competitions: 0};

    onMount(async ()=>{
        const data = await HttpHelper.Get<Idashboard>('api/dashboard');
        console.log(data);
        dataBoard = data.data as Idashboard;
    })
	...
	<div class="tiles-area clear">
		...
		>
			...
			>
				...
				<span class="badge-bottom">{dataBoard.competitions || 0}</span>
			</div>
			<a
				href="/categories"
				data-role="tile"
		...
		>
			...
			<div data-role="tile" data-size="wide" data-effect="image-set">
				...
				<img src="images/kata2.jpeg" />
				<img src="images/HAWKtm.png" />
		...
		<div
			...
			data-group-title="configuration"
		>
		<a href="/kata" data-role="tile" class="bg-red fg-white">
			<span class="mif-accessible icon" />
			<span class="branding-bar">Manage Kata</span>
		</a>
		</div>
